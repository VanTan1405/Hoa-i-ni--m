...
export const TABLES:Record<string,{private?:boolean;label:string;fields:string[]}>={
 ...
 HO_SO:{label:"Hồ sơ bạn học",fields:["member_id","name","nickname","bio","seat","avatar_file_id","avatar_file_name","avatar_mime_type"]},
 ...
 CHAT:{label:"Phòng chat lớp",fields:["content"]},
...
export const VIEW_LABELS:Record<string,string>={album:"Album lớp mình",timeline:"Chuyện ngày ấy",members:"Bạn học năm ấy",chat:"Phòng chat lớp",guestbook:"Trang lưu bút",capsule:"Hộp thư thời gian",events:"Hẹn ngày gặp lại",music:"Góc âm nhạc",admin:"Quản trị lớp"};
